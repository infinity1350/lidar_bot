...
def generate_launch_description():
    ...
    launch_robot_arg = DeclareLaunchArgument(
        'launch_robot',
        default_value='true',
        description='Set false if robot bringup is already running',
    )

    use_sim_arg = DeclareLaunchArgument(
        'use_sim',
        default_value='false',
        description='Set true to launch simulation bringup, false for real robot',
    )
    ...
    # Delay Nav2 startup slightly so robot bringup finishes first
